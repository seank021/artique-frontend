...
export default function FAQDetail ({isCookie}) {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={tw`flex-col`} showsVerticalScrollIndicator={false}>
          {/* 공지정보 */}
          <View style={tw`flex-col justify-center h-[57px] mx-5 my-5`}>
            <Text style={tw`text-base text-[#191919] font-normal`}>질문 제목</Text>
          </View>
...
We’ve only used one breakpoint in this example, but you could easily customize this component at other sizes using the sm, lg, xl, or 2xl responsive prefixes as well.
          ...
          {/* 다른 질문 */}
          <Pressable onPress={goToFAQDetail} style={tw`flex-row justify-between items-center h-[57px] mx-5`}>
              <View style={tw`flex-row`}>
                <Text style={tw`text-xs text-[#191919] font-normal mr-[15px]`}>이전 글</Text>
                <Text style={tw`text-xs text-[#191919] font-normal`}>질문 제목</Text>
              </View>
