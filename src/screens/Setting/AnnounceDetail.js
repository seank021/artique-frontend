...
export default function AnnounceDetail ({isCookie}) {
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        {/* 공지내용 */}
        <ScrollView style={tw`flex-col h-[430px] my-5 mx-5`} showsVerticalScrollIndicator={false}>
          <Text style={tw`text-xs text-[#191919] font-normal leading-[23px]`}>… 스타트업레시피 데이터에 따르면 현재 기준으로 올해 에듀테크 분야에 유입된 자금은 400억 원이 채 되지 않는 것으로 나타났는데요. 최대 투자금도 100억 원을 상회 하는 등 다른 분야보다 더 적은 금액이 유입됐습니다.
...
저는 링글에서 유저가 1:1 화상 과외를 마치고 나면 유저의 영어실력을 진단하는 머신러닝 엔진을 개발하고 있습니다!</Text>
        </ScrollView>
