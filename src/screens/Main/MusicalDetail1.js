  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={tw`flex-row items-center justify-between mt-5 mb-[14px]`}>
        ...
        <Text style={tw`ml-[8px] text-[#191919] text-base font-medium`}>
          {musicalInfo.title}
        </Text>
      ...
      <ScrollView>
        ...
        <MusicalInfoForm
          poster={musicalInfo.poster}
          title={musicalInfo.title}
          score={musicalInfo.averageScore}
          date={musicalInfo.date}
          place={musicalInfo.place}
          duration={musicalInfo.duration}
          casting={musicalInfo.casting}></MusicalInfoForm>
        <View style={tw`mb-[27.56px]`}></View>
        <StoryForm story={musicalInfo.story}></StoryForm>
        <View style={tw`mb-[35px]`}></View>
        <AverageScoreForm
          averageScore={musicalInfo.averageScore}
          scoreCount={scoreCount}></AverageScoreForm>
        <View style={tw`mb-[35px]`}></View>
        <View
          style={tw`flex flex-row w-[90%] justify-between items-center self-center mb-[10px]`}>
          <Text style={tw`text-[#191919] text-base font-medium`}>
            리뷰 ({reviewInfo.totalReviewCount})
          </Text>
        ...
        <ShortReviewForm
          reviewInfo={reviewInfo.reviews[0]}
          onPressThumbsUp={() =>
            onPressThumbsUp(reviewInfo.reviews[0].reviewId)
          }
          onPressArrowCircledRight={() =>
            goToSeeMore1(reviewInfo.reviews[0].reviewId)
          }
          isCookie={isCookie}></ShortReviewForm>
        <ShortReviewForm
          reviewInfo={reviewInfo.reviews[1]}
          onPressThumbsUp={() =>
            onPressThumbsUp(reviewInfo.reviews[1].reviewId)
          }
          onPressArrowCircledRight={() =>
            goToSeeMore1(reviewInfo.reviews[1].reviewId)
          }
          isCookie={isCookie}></ShortReviewForm>
      </ScrollView>
    </SafeAreaView>
