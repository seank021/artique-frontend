...
export default function StoryForm(props) {
    ...
    return (
        ...
        <Text style={tw`text-[#191919] text-base font-medium mb-[10px]`}>
            줄거리
        </Text>
        <View
            style={{
            ...
            <Text
            style={tw`text-[#191919] text-sm text-justify leading-6`}>
            ...
            <Image
                source={
                isExpanded
                    ? require('@images/chevron_up.png')
                    : require('@images/chevron_down.png')
                }
